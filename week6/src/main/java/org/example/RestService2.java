...
public class RestService2 {
   ...
   public RestService2(){
        this.university=new University("Goethe Uni Frankfurt");
        this.university.addStudent("Rana","22-07-1995","cse");
        this.university.addStudent("Jewel","23-09-2000","eee");
    }
    @Path("/hello")
    @GET
    ...
    public String modifySubjectByName(@QueryParam("name")String name, @QueryParam("subject")String subject){
        ...
        return String.format("subject has been modfied from %s to %s",prevSub,subject);
